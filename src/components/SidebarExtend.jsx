...
function Content() {
  ...
  const handleClick = () => {
    history("/I"); // Navigate to the specified URL
  };
  return (
    <div className="flex flex-col ml-3 mr-3">
      ...
      <div
        className="bg-[#d3e3fd] flex items-center justify-center w-52 rounded-xl mt-2"
      ...
      <div className="flex items-center justify-center w-52 rounded-xl mt-2"  onClick={handleClickStarred}>
        <div className="flex w-[90%] items-center h-7 justify-center">
